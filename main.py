...
async def main():
    ...
    await tweeter_scraper.search_keyword_tweets_and_save_to_csv("ChainCoin", "2017-07-14", "2017-07-12")
    await tweeter_scraper.search_user_tweets_and_save_to_csv("elonmusk")
